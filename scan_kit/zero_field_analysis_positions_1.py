...
session_ids = ["1062005917", "1436309964", "919361899"]
# session_ids = ["1968011512"]
...
# Define discrete colors and markers for different sessions
session_colors = ["blue", "red", "green", "orange", "purple", "brown", "pink", "gray"]
...
for i, session_data in enumerate(all_session_data):
    ...
    #     cmap="viridis",
    #     alpha=0.3,
    #     label=f"IC2 (Session {session_id})",
    #     marker="s",
    #     s=50,
    #     edgecolors="black",
    #     linewidth=0,
